...
to value of \textit{Median} and Value $a_i^R$ of all elements in R is greater than \texit{Median}.
...
return we see that the sum of all elements to the Left of the \texit{Pivot} in the partitioned
array is less than 1/2 and when we add the weight of the \texit{Pivot} the aggregated weight
becomes $\geq{1/2}$ then we say that the \texit{Pivot} is the Weighted Median which is true
